<?php /* Smarty version 2.6.20, created on 2010-08-08 21:04:14
...
<div id="allscreen">
  <div id="allcontent" style="width: 960px;background-color: white;">
    <div id="allheader"><?php echo $this->_tpl_vars['header']; ?>
</div>
    <div id="allleft"><?php echo $this->_tpl_vars['left_col']; ?>
</div>
    <div id="allcenter">
      <?php echo $this->_tpl_vars['center_col']; ?>

    </div>
    <div id="allright"><?php echo $this->_tpl_vars['right_col']; ?>
</div>
    <div id="allfooter"><?php echo $this->_tpl_vars['footer']; ?>
</div>
  </div>
</div>
<?php echo '
